...
<template>
   <footer class="p-4 bg-white md:p-8 lg:p-10 dark:bg-gray-800">
    <div class="mx-auto max-w-screen-xl text-center">
        ...
        <p class="my-6 text-gray-500 dark:text-gray-400">Project build with customers in mind.</p>
        <ul class="flex flex-wrap justify-center items-center mb-6 text-gray-900 dark:text-white">
            <!-- <li>
                <a href="/" class="mr-4 hover:underline md:mr-6 ">Home</a>
            </li> -->
            <li>
                <a href="/ideas" class="mr-4 hover:underline md:mr-6">Ideas</a>
            </li>
            <li>
                <a href="/activity-board" class="mr-4 hover:underline md:mr-6">Activity Board</a>
            </li>
            <li>
                <a href="/changelog" class="mr-4 hover:underline md:mr-6 ">Changelog</a>
            </li>
            <li>
                <a href="/faq" class="mr-4 hover:underline md:mr-6 ">F.A.Q</a>
            </li>
            <li>
                <a href="/contact" class="mr-4 hover:underline md:mr-6">Contact</a>
            </li>
        </ul>
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">©{{new Date().getFullYear()}} <a href="#" class="hover:underline">Qubbit</a>. All Rights Reserved.</span>
    </div>
  </footer>
</template>
